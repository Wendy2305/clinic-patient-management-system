...
const EntryFlatList: React.FC<Props> = ({ entries }) => {
    ...
    return (
        <FlatList
            style={{ width: '100%', padding: 3, backgroundColor: '#ff99ac' }}
            data={entries}
            renderItem={({ item }) => (
            ...
            ListHeaderComponent={
                () => (
                    <View style={[styles.inputContainerStyle, { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: "#ff4d6d" }]}>
